...
TIGER direct. Campus land-bay geometry is no longer a fixture — the
ingest engine captures it as vintaged data (`data/geometry/`, brief 09),
so the map's land shapes move with the monthly snapshot automatically.
